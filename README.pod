...
the dependencies can be installed by running:
        ...
        apt-get install fuse libfuse-perl libfile-which-perl
        gem install lolcat
...
You could technically keep your PATH on the end (PATH=/tmp/fuse-colors:$PATH), 
...
You can force the ncurses cache to update by running (assuming your mount is /tmp/fuse-colors):

		cat /tmp/fuse-colors/refresh-ncurses-cache
